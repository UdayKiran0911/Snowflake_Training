...
-- Transient tables
    -- Time travel retention period
    -- NO Fail Safe
    -- Can create transient database and schema
-- Temporary tables
    -- Time travel retention period
    -- table only avilable for the session
    -- NO Fail Safe
    -- Can have the same name as of permanent table
    -- Can not create transient database and schema
